...
<div class="shell">
  <header>
    <div class="brand"><span class="dot" aria-hidden="true"></span><strong>SN API Explorer</strong><span class="brand-meta" id="brand-meta"></span><a class="xlink" id="xlink">GraphQL explorer →</a><a class="xlink repo" href="https://github.com/tehubersheezy/servicenow-tools" target="_blank" rel="noopener">GitHub ↗</a></div>
