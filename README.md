...
The two cross-link to each other. Both are **build artifacts** — regenerated from the scraped corpora, never hand-edited — so they never drift from the instance.
